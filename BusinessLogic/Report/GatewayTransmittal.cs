...
namespace BusinessLogic.Report
{
    public class GatewayTransmittal
    {
        ...
        public static DataSet GetCargoTransfer(string conSTR, string DateStr, string OriginStr , string DestinationStr)
        {
            return DAL.Reports.CargoTransfer.GetCargoTransfer(conSTR, DateStr, OriginStr, DestinationStr);
        }
